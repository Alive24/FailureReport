 ...
 *
 * This module is domain-agnostic: the application host binds a mounted extension
 * to a configured worktree manager, while Root retains the only approved path to
